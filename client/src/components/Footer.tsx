...
export default function Footer() {
  ...
  return (
    <footer className="dark-footer text-gray-300 mt-8">
        ...
        <div className="border-t border-[#333] mt-4 pt-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-4 text-sm">
              <a href="#" className="text-gray-400 hover:text-blue-400 transition">{texts.privacy}</a>
              <a href="#" className="text-gray-400 hover:text-blue-400 transition">{texts.terms}</a>
              <a href="#" className="text-gray-400 hover:text-blue-400 transition">{texts.contact}</a>
            </div>
          </div>
        </div>
      </div>
